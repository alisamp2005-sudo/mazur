...
import { LayoutDashboard, LogOut, PanelLeft, Users, Phone, PhoneCall, Settings, Star, FileText, MessageSquare, Headphones, BarChart3, Sparkles } from "lucide-react";
...
const voximplantMenuItems = [
  ...
  { icon: Sparkles, label: "Create Agent", path: "/voximplant/create-agent" },
