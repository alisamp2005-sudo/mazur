...
- [x] Design database schema for storing call recordings metadata
- [x] Add ElevenLabs API functions for fetching conversation details and audio
- [x] Create call recordings page with table (time, caller, recording, transcript)
- [x] Implement audio player for recordings
- [x] Add import functionality to fetch recordings from ElevenLabs
- [x] Format transcripts to differentiate client and AI speakers

## Real-time Call Status
- [x] Add polling mechanism to Call Logs page (auto-refresh every 5 seconds)
- [x] Update call status display with real-time data
- [x] Add visual indicators for status changes (auto-refresh toggle button)

## Telegram Integration
- [x] Design database schema for Telegram settings
- [x] Create Telegram settings page in admin panel
- [x] Implement Telegram bot for sending recordings
- [x] Add function to forward recordings with transcripts to Telegram
- [x] Add UI to link/unlink Telegram account
- [x] Automatic forwarding of recordings after ElevenLabs sync
